        ...
        <div style={{ maxWidth: 900, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, alignItems: 'center' }}>
          <div>
            ...
            <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'clamp(26px,3.5vw,38px)', letterSpacing: '-0.02em', marginBottom: 16 }}>
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: 12, flexWrap: 'wrap', justifyContent: 'flex-start' }}>
                <img
                  src="/avatar.png"
                  alt="AI"
                  style={{
                    ...
                    objectFit: 'cover',
                    objectPosition: 'top center',
                    border: '2px solid rgba(27,79,189,0.4)',
                    boxShadow: '0 0 16px rgba(27,79,189,0.25)',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
            ...
            { icon: '🎮', title: 'Arcade Lab', sub: 'Snake + Bug Blaster', color: '#F43F5E' },
            ].map((c,i) => (
