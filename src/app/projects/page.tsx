    ...
    <div style={{ paddingTop: 70 }}>
      ...
      <section style={{ padding: '80px 24px 60px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'clamp(36px, 5vw, 56px)', marginBottom: 20 }}>
            Featured <span className="gradient-text">Projects</span>
          </h1>
          <p style={{ color: 'var(--muted)', fontSize: 18, lineHeight: 1.8 }}>
            Enterprise-grade solutions built with modern technologies, AI integration, and production-ready practices.
          </p>
        </div>
      </section>
