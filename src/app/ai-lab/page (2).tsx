...
const PORTFOLIO_DATA = [
  ...
  { title: 'Python',      type:'Skill', href:'/about', tags:['python','backend','ai'],       desc:'95% — primary AI/backend language' },
  { title: 'FastAPI',     type:'Skill', href:'/about', tags:['fastapi','api','backend'],      desc:'90% — high-performance API framework' },
  { title: 'LangGraph',   type:'Skill', href:'/about', tags:['langgraph','ai','agents'],     desc:'88% — multi-agent AI orchestration' },
  { title: 'GPT-4/OpenAI',type:'Skill',href:'/about', tags:['gpt','openai','llm','ai'],      desc:'92% — large language model applications' },
  { title: 'Next.js 14',  type:'Skill', href:'/about', tags:['next.js','react','frontend'],  desc:'86% — full-stack React framework' },
  { title: 'PostgreSQL',  type:'Skill', href:'/about', tags:['postgresql','sql','database'],  desc:'86% — production database design' },
  { title: 'Docker',      type:'Skill', href:'/about', tags:['docker','devops'],              desc:'75% — containerization & deployment' },
  { title: 'Power BI',    type:'Skill', href:'/about', tags:['power bi','analytics','dax'],   desc:'88% — business intelligence dashboards' },
]
